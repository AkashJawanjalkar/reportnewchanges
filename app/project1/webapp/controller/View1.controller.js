...
sap.ui.define([
    ...
    return Controller.extend("project1.controller.View1", {
        ...
        // This function helps to call the backend services
...
.footer {
      ...
      Created By: ${escHtml(createdBy || "-")}
        ...
        //===================================================================================================
        // Load SKU Componant Tab Data
        // onPressGoInSKUTab: function () {
        ...
        //     console.log("Payload : ", oPayLoad);
        //     this.byId("SKUTabFilterBox").setVisible(true);
        //     this.byId("idRecordTablePanel").setVisible(true);
        ...
        // onApiFilterReset: function () {

        //     this.byId("SKUPkgSiteId").setValue("");
        //     // this.byId("SKURadioButtonId").setValue("");
        //     this.byId("SKURadioButtonId").setSelectedIndex(-1);

        //     this.byId("SKUTabFilterBox").setVisible(false);
        //     this.byId("idRecordTablePanel").setVisible(false);

        // },

        // onSKUValueHelpRequest: function () {
        //     const oView = this.getView();

        //     if (!this._oSKUDialog) {

        //         this._oSKUDialog = new sap.m.Dialog({
        ...
        //             liveChange: this.onSKUVHSearch.bind(this)
        //         });

        //         const oList = new sap.m.List("idCMSWIPClosedVHList", {
        ...
        //                 })
        //             },
        //             select: this.onSKUVHSelect.bind(this)
        //         });

        //         oList.setModel(this.getView().getModel("oPkgSite"));


        //         this._oSKUDialog.addContent(oSearch);
        //         this._oSKUDialog.addContent(oList);

        //         this._oSKUDialog.addButton(new sap.m.Button({
        //             text: "Close",
        //             press: () => this._oSKUDialog.close()
        //         }));

        //         oView.addDependent(this._oSKUDialog);
        //     }

        //     this._oSKUDialog.open();
        // },
        ...
        // onSKUVHSearch: function (oEvent) {
        //     const sValue = oEvent.getParameter("newValue");
        //     const oList = sap.ui.getCore().byId("idCMSWIPClosedVHList");
        ...
        // onSKUVHSelect: function (oEvent) {
        //     const sSelected = oEvent.getParameter("listItem").getTitle();
        //     this.byId("SKUPkgSiteId").setValue(sSelected);
        //     this._oSKUDialog.close();
        // },
        ...
        // Load CMS WIP Data 
        // onGoPressCMSWIP: function () {
        //     var oDateRange = this.byId("CMSWIPDataRangeId");
        //     var dFrom = oDateRange?.getDateValue ? oDateRange.getDateValue() : null;
        //     var dTo = oDateRange?.getSecondDateValue ? oDateRange.getSecondDateValue() : null;
        //     console.log("From Data : " + dFrom + " ToDate : " + dTo);

        //     const sActualPkgSite = this.byId("CMSWIPActualPkgSiteId").getValue();
        //     console.log("Selected Value :", sActualPkgSite);
        ...
        // onApiFilterResetCMSWIP: function () {
        //     this.byId("dynamicFiltersCMSWIP").setVisible(false);
        //     this.byId("idCMSWIPPanel").setVisible(false);

        //     this.byId("CMSWIPDataRangeId").setValue("");
        //     this.byId("CMSWIPActualPkgSiteId").setValue("");
        ...
        // onGoPressCMSClosed: function () {
        //     var oDateRange = this.byId("DateRangeCMSClosedId");
        //     var dFrom = oDateRange?.getDateValue ? oDateRange.getDateValue() : null;
        //     var dTo = oDateRange?.getSecondDateValue ? oDateRange.getSecondDateValue() : null;
        //     console.log("From Data : " + dFrom + " ToDate : " + dTo);

        //     const sActualPkgSite = this.byId("idCMSWIPClosedSiteSelect").getValue();
        //     console.log("Selected key : ", sActualPkgSite);
        ...
        // onApiFilterResetCMSClosed: function () {
        //     this.byId("DateRangeCMSClosedId").setValue("");
        //     this.byId("idCMSWIPClosedSiteSelect").setValue("");


        //     this.byId("idCMSClosedPanel").setVisible(false);
        //     this.byId("dynamicFiltersCMSClosed").setVisible(false);

        // },

        // onValueHelpCMSWIPClosedRequest: function () {
        //     const oView = this.getView();

        //     if (!this._oCMSWIPClosedDialog) {

        //         this._oCMSWIPClosedDialog = new sap.m.Dialog({
        //             title: "Select Packaging Site",
        //             contentWidth: "400px",
        //             draggable: true,
        //             resizable: true,
        ...
        //         const oSearch = new sap.m.SearchField({
        //             liveChange: this.onCMSWIPClosedVHSearch.bind(this)
        //         });
        ...
        //                 })
        //             },
        //             select: this.onCMSWIPClosedVHSelect.bind(this)
        //         });
        ...
        //         this._oCMSWIPClosedDialog.addContent(oSearch);
        //         this._oCMSWIPClosedDialog.addContent(oList);


        //         this._oCMSWIPClosedDialog.addButton(new sap.m.Button({
        //             text: "Close",
        //             press: () => this._oCMSWIPClosedDialog.close()
        //         }));

        //         oView.addDependent(this._oCMSWIPClosedDialog);
        //     }

        //     this._oCMSWIPClosedDialog.open();
        // },

        // onCMSWIPClosedVHSearch: function (oEvent) {
        //     const sValue = oEvent.getParameter("newValue");
        //     const oList = sap.ui.getCore().byId("idCMSWIPClosedVHList");
        ...
        // onCMSWIPClosedVHSelect: function (oEvent) {
        //     const sSelected = oEvent.getParameter("listItem").getTitle();
        //     this.byId("idCMSWIPClosedSiteSelect").setValue(sSelected);
        //     this._oCMSWIPClosedDialog.close();
        // },
        ...
        //         onPressDownloadSKU: function (oEvent) {
        ...
        //             if (!this._oActionSKUSheet) {
        //                 this._oActionSKUSheet = new sap.m.ActionSheet({
        //                     placement: sap.m.PlacementType.Top,
        //                     buttons: [
        //                         new sap.m.Button({
        //                             text: "Download as PDF",
        //                             press: () => that._downloadSKUFile("pdf", that._currentTableId)
        //                         }),
        //                         new sap.m.Button({
        //                             text: "Download as Excel",
        //                             press: () => that._downloadSKUFile("excel", that._currentTableId)
        //                         }),
        //                         new sap.m.Button({
        //                             text: "Download as CSV",
        //                             press: () => that._downloadSKUFile("csv", that._currentTableId)
        //                         })
        //                     ]
        //                 });
        //             }

        //             this._currentTableId = buttonId;

        //             this._oActionSKUSheet.openBy(oButton);
        //         },

        //         _getCurrentSKUTableData: function (buttonId) {
        //             let tableId = null;

        //             if (buttonId === "SKUDownloadButton") {
        //                 tableId = "idRecordTable";
        //             }
        //             else if (buttonId === "CMSWIPDownloadBId") {
        //                 tableId = "idCMSWIPTable";
        //             }
        //             else if (buttonId === "CMSCloseDownloadBId") {
        //                 tableId = "idCMSClosedTable";
        //             }
        ...
        //             tableId = "";
        //             return oBinding.getContexts().map(ctx => ctx.getObject());
        //         },

        //         _downloadSKUFile: function (type, buttonId) {
        //             const aData = this._getCurrentSKUTableData(buttonId);
        ...
        //             if (type === "csv") this._exportSKUCSV(aData);
        //             if (type === "excel") this._exportSKUExcel(aData);
        //             if (type === "pdf") this._exportSKUPDF(aData, buttonId);
        //         },

        //         _exportSKUCSV: function (aData) {
        //             const cols = Object.keys(aData[0]);
        //             let csv = cols.join(",") + "\n";
        ...
        //         _exportSKUExcel: function (aData) {
        //             const cols = Object.keys(aData[0]);

        //             let excel = "<table border='1'><tr>";
        //             cols.forEach(c => excel += `<th>${c}</th>`);
        //             excel += "</tr>";

        //             aData.forEach(row => {
        //                 excel += "<tr>";
        //                 cols.forEach(c => excel += `<td>${row[c] || ""}</td>`);
        //                 excel += "</tr>";
        //             });
        //             excel += "</table>";
        ...
        //             const link = document.createElement("a");
        //             link.href = URL.createObjectURL(blob);
        //             link.download = "SKU_Data.xls";
        //             link.click();
        //         },

        //         _getVisibleColumns: function (buttonId) {
        ...
        //             if (!aItems.length) {
        //                 console.warn("No items found in table");
        //                 return [];
        //             }

        //             const firstRow = aItems[0];
        //             const aCells = firstRow.getCells();

        //             const aVisible = [];

        //             aColumns.forEach((col, index) => {

        //                 if (!col.getVisible()) return;

        //                 const label = col.getHeader()?.getText?.() || "";

        //                 const cell = aCells[index];

        //                 let key = "";

        //                 if (cell) {
        //                     const bind = cell.getBindingInfo("text");
        //                     if (bind && bind.parts && bind.parts.length > 0) {
        //                         key = bind.parts[0].path;
        //                     }
        //                 }
        ...
        //         _exportSKUPDF: async function (aData, tableID) {

        //             var aVisibleCols = this._getVisibleColumns(tableID);
        //             var sTitle = this._exportTitle[tableID];

        //             // Load Logo + Background as Base64
        //             const logoBase64 = await this._getBase64(sap.ui.require.toUrl("project1/img/viatrisLogo.png"));
        //             const bgBase64 = await this._getBase64(sap.ui.require.toUrl("project1/img/background_img.jpg"));
        ...
        //             function chunkColumns(cols, size) {
        //                 const chunks = [];
        ...
        //             var colChunks = chunkColumns(aVisibleCols, 10);
        //             var sTablesHTML = "";

        //             colChunks.forEach((chunk, index) => {
        //                 var sTable = "<table><thead><tr>";

        //                 chunk.forEach(c => sTable += "<th>" + esc(c.label) + "</th>");

        //                 sTable += "</tr></thead><tbody>";

        //                 aData.forEach(oRow => {
        //                     sTable += "<tr>";
        //                     chunk.forEach(c => sTable += "<td>" + esc(oRow[c.key] || "") + "</td>");
        //                     sTable += "</tr>";
        //                 });

        //                 sTable += "</tbody></table>";

        //                 sTablesHTML += `<h3>Columns ${index * 10 + 1} - ${Math.min((index + 1) * 10, aVisibleCols.length)}</h3>`;
        //                 sTablesHTML += sTable;
        //                 sTablesHTML += `<div style="page-break-after: always;"></div>`;
        //             });
        ...
        //    const oInput = this.byId("ImplementationDeadlineID").$().find("input");

        //    // Block all keyboard + paste + drop in one line

        //    oInput.on("keydown keypress paste drop", e => e.preventDefault());
